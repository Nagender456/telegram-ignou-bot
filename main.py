...
def main():
    ...
    teleBot = TelegramClient('bot', os.getenv('teleApiId'), os.getenv(
        'teleApiHash'), request_retries=100, connection_retries=100, retry_delay=5).start(bot_token=os.getenv('teleBotToken'))
